...
public final class Constants {
    ...
    public static final double kDriveBaseRadius = Math.hypot(kWheelBase / 2.0, kTrackWidth / 2.0);
        ...
        public static final double kFrontLeftAbsoluteEncoderOffsetRad = 3.201417904317333;
        public static final double kBackLeftAbsoluteEncoderOffsetRad = 0.176407790606849;
        public static final double kFrontRightAbsoluteEncoderOffsetRad = 2.558679954193249;
        public static final double kBackRightAbsoluteEncoderOffsetRad = 2.78724309158821; 
